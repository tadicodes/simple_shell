...
/**
 * finds_builtin - this finds a builtin command
...
/**
 * finds_cmd - this finds a command in PATH
 * @info: the parameter & return info struct
 *
 * Return: void
 */
...
/**
 * forks_cmd - fork's an exec thread to run cmd
 * @info: is the parameter & return info struct
 *
 * Return: void
 */
