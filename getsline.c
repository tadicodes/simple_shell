 ...
 * @info: le param struct
 * @buf: addy of buffer
 * @len: addy of leng var
 * Return: bytes read
 */
 ...
 * @info: le parameter struct
 * Return: bytes to reads
 */
...
/**
 * _getline - get next line of input frm STDIN
 * @info: param structure
 * @ptr: addy of pointer buffer, preallocated or NULL
